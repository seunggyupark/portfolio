...
import portfolioProject from '../../assets/img/portfolio_project.gif';
import reubensProject from '../../assets/img/reubens_project.gif';
import pigeonProject from '../../assets/img/pigeon_project.gif';
import portfolioStill from '../../assets/img/portfolio_still.png';
    ...
    return (
        <div className={classes.Container}>
            ...
            <div className={classes.ContentContainer}>
                <Project hideStill={autoPlayPosition === 0 ? true : null} title={'Brewery Management App'} 
                         still={reubensStill} gif={reubensProject} description={reubensDescription} 
                         modalContent={reubensThoughts} linkStyle={{display: 'none'}} />

                <Project hideStill={autoPlayPosition === 1 ? true : null} title={'Pigeon Task'} 
                         link={"http://pigeontask.com/"} still={pigeonStill} 
                         gif={pigeonProject} description={pigeonDescription} modalContent={pigeonThoughts} />

                <Project hideStill={autoPlayPosition === 2 ? true : null} title={'Portfolio'} 
                         link={"https://twitter.com/AreWeCodingYet"} still={portfolioStill} 
                         gif={portfolioProject} description={portfolioDescription} modalContent={portfolioThoughts} 
                         borderStyle={{border: 'none'}} linkStyle={{display: 'none'}}/>
            </div>
        </div>
    );
}

...
const description = (<p>An email formatter for making task schedules for production environments. Most task management applications, such as Monday, are fantastic but a bit too complex for production and manufacturing. Employees may simply need a list of
...
I have seen this same issue in manufacturing environments where teams are managed with email and I wanted to present a simple solution while practicing a MVC model.</p>);

...
const thoughts = (<p>This is my latest project that I completed as an entry into backend development. It helped me understand how everything works together, answering questions 
    I had about how authentication works on the backend and how sensitive data is transferred to the client.<br/><br/>I became familiar with using React hooks, complex state management with 
    custom hooks, MongoDB, and Node.js/Express.</p>);

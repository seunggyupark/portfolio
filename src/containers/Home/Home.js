...
const Home = props => (
    <div className={classes.Background}>
        <div className={classes.Home}>
            ...
            <h2>I am a <span className={classes.Job1}>web developer</span>, <span className={classes.Job2}>designer</span>, and <span className={classes.Job3}>process engineer</span> based in Seattle.<br/>

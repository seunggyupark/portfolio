...
import classes from './ExperiencesCarousel.module.css';
...
const Carousel = props => {
    ...
    const renderSliders = () => {
        order.forEach((element, index) => {
            sliderComponents.push((<ExperienceSlider key={index} title={title[element]} bulletPoints={list[element]} Image={img[element]}/>))
        });
    }
    renderSliders();
